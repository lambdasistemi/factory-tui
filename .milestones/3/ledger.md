...
| T-B (#19) | ticket | A clearly-marked milestone pre-release line a stranger can install, which cannot displace the product line | DISPATCHED — brief `/tmp/ms-3/t-b/brief.md` sha256 `c1ed3c92081ac9ca`; **ACCEPTED** PR#20 merged 0ba974e2; issue #19 closed. Lane PARKED not archived — first milestone tag push remains, blocked on Q-002 | `factory-tui-ms3-t-unknown-prerelease-line` |
